...
import type { Serializer, PersistedStateFactoryOptions } from 'pinia-plugin-persistedstate'
import { createPersistedState } from 'pinia-plugin-persistedstate'
import { type Encryption, EncryptionFactory } from '@/utils/cipher'
import { cacheCipher, enableStorageEncryption } from '@/settings/encryptionSetting'

export const PERSIST_KEY_PREFIX = 'ADMIN_DESIGN'
...
export function createPersistedStateOptions(keyPrefix: string): PersistedStateFactoryOptions {
  return {
    ...
    serializer: customSerializer(enableStorageEncryption)
  }
}
