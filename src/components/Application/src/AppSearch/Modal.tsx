        ...
        <Transition name='zoom-fade' mode='out-in'>
          {
            ...
            (
              <div class={compoStyle[prefixCls]} onClickStop>
                <div
                  class={compoStyle[`${prefixCls}-content`]}
                ...
                >
                  ...
                  <div
                    v-show={unref(getIsNotData)}
                    class={compoStyle[`${prefixCls}-not-data`]}
                  >暂无搜索结果</div>
                  <ul
                    ref={scrollWrap}
                    v-show={!unref(getIsNotData)}
                    class={compoStyle[`${prefixCls}-list`]}
                  >
                    {
                      unref(searchResult).map((item, index) => {
                        return (
                          ...
                          >
                            ...
                            <div class={compoStyle[`${prefixCls}-list__item-text`]}>
                              { item.name }
                            </div>
                          </li>
                        )
